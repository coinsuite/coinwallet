...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="coinwallet RPC"`)
...
// method.  This may be a request that is handled directly by coinwallet, or
